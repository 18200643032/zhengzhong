...
class Goods(models.Model):
    ...
    goods_desc =UEditorField(imagePath="goods/images/",width=1000,height=300,filePath="goods/files",default="",verbose_name=u"内容")
...
class TndexAd(models.Model):
    categort = models.ForeignKey(GoodsCategory,related_name="categort",verbose_name="商品类目")
